namespace KSL.Gestures.Classifier
{
    ...
    public sealed class Classifier
    {
        ...
        public void init()
        {
            ...
            {
                ID = 6,
                Codes = new List<int> { (int)WordsEnum.What, (int)WordsEnum.Food },
            ...
            {
                ID = 8,
                Codes = new List<int> { (int)WordsEnum.What, (int)WordsEnum.Trail },
                Text = "What is a trail?"
            };
            this.sentencesDictionary.Add(s);
            ...
            {
                ID = 9,
                Codes = new List<int> { (int)WordsEnum.Trail, (int)WordsEnum.Trial2 },
                Text = "Trail trial2"
            };
            this.sentencesDictionary.Add(s);
            ...
            {
                ID = 9,
                Codes = new List<int> { (int)WordsEnum.Live, (int)WordsEnum.Trail },
                Text = "Live trail"
            };
            this.sentencesDictionary.Add(s);
